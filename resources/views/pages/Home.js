...
let getMoviesList = async () => {
  ...
  try {
    const response = await fetch(
      `https://api.themoviedb.org/3/discover/movie?api_key=1756017a03786e306fc358d4a4186de0`
    );
  ...
  render: async () => {
    ...
    let view = /*html*/ `
                ...
                <div class="row">
                    ...
                    ${movies
                      .map(
                        movie => /*html*/ `<div class="col-xs-12 col-sm-12 col-md-6 col-lg-3" style="margin-top: 2em" >
        <div class="card">
